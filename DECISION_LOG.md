...
**Review-Gate corrections applied before merge (2026-07-29).** Four findings on PR #59 were fixed, all within `mexico.json` (with `DECISION_LOG` and the two coverage files realigned):
